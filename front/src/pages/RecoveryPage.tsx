...
export default function RecoveryPage() {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        if (codeWasSent) {
            try {
                await axios.patch(`${backendIp}/api/users/password/reset`, {
                    email,
                    code,
                    newPassword,
            ...
            try {
                await axios.get(`${backendIp}/api/users/password/recoverycode/${email}`, {
                    ...
                    <div className="py-2 mx-10 my-0
                        ...
                        <div className="bg-white px-8 pt-8 pb-10
                            ...
                            <form className=" " onSubmit={(e) => onSubmit(e)}>
                                <h1 className="text-black tracking-wide text-3xl font-black mb-8 centerForm">Recover password</h1>

                                <div className="mb-2 ">
                                    <h2 className="textOverInputFields ">To recover your password,enter the</h2>
                                    <h2 className="textOverInputFields ">e-mail address you provided during</h2>
